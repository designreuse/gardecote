...
// c est une concession de type cotiere non pontee
	...
	//	System.out.println(nav.getNumimm());
		...
		qLicence qlicencebatlast1=new qLicence(qtyplic20,qTypeEnc.MRT,qZone7,qnation3,qc,enumSupport.Individuel,qreg1,qconsignataire2,qConcessionPC,
		...
		qlicencebatlast1.setQcatressources(qc);
		licenceService.save(qlicencebatlast1);
		//qlicencebatlastrepository.save(qlicencebatlast1);
		// q1.setQlicence(qlicencebatlast1);



		qLicence qlicencebatlast2=new qLicence(qtyplic20,qTypeEnc.MRT,qZone7,qnation3,qc,enumSupport.Individuel,qreg1,qconsignataire2,qConcessionPC,
		...
		qreg1.setQlicencedernier(qlicencebatlast2);
		registrenavireService.save(qreg1);
