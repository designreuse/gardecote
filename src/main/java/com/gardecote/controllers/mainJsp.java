...
public class mainJsp  {
	...
	public String creerDocument(Model model,@RequestParam(name="pagedebut") String debut,@RequestParam(name="pagefin") String fin,HttpServletRequest httpServletRequest) {
